describe("ALW Sign Up", () => {
  it("Upper Grade Sign Up", () => {
    ...
    cy.intercept(
      ...
      "https://lms-" +
        Cypress.env("server") +
        "/api/service_based_subscription/plans/1/enroll/"
    ).as("enrollStudent");
    ...
    cy.intercept(
      ...
      "https://lms-" +
        Cypress.env("server") +
        "/api/service_based_subscription/plans/"
    ...
    cy.get(':nth-child(1) > .Subscription_paymentPlans__plan__2SFvp').click();
    cy.get(".NewButton_btn-primary__7Sw3_").click();
    ...
    cy.get(':nth-child(1) > .Services_row__1lTlC > :nth-child(1) > .Services_service__box__1UPlA').click();
    cy.get(':nth-child(1) > .Services_row__1lTlC > :nth-child(2) > .Services_service__box__1UPlA').click();

    // Second Subject Services
    cy.get(':nth-child(2) > .Services_row__1lTlC > :nth-child(1) > .Services_service__box__1UPlA').click();
    cy.get(':nth-child(2) > .Services_row__1lTlC > :nth-child(2) > .Services_service__box__1UPlA').click();
